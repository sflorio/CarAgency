    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, false, new DateTime(2021, 2, 25, 1, 18, 35, 568, DateTimeKind.Local).AddTicks(4544), "migration", null, null, "Debito", null, null });

            migrationBuilder.InsertData(
                table: "ConceptosFinancieros",
                columns: new[] { "ConceptoFinancieroId", "Active", "CreateDateTime", "CreateUser", "DeleteDateTime", "DeleteUser", "Descripcion", "UpdateDateTime", "UpdateUser" },
                values: new object[] { 2, false, new DateTime(2021, 2, 25, 1, 18, 35, 569, DateTimeKind.Local).AddTicks(6969), "migration", null, null, "Credito", null, null });

            migrationBuilder.InsertData(
                table: "Paises",
                columns: new[] { "PaisId", "Descripcion" },
